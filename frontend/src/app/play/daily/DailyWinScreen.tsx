...
const DailyWinScreen: React.FC = () => {
  ...
  return (
    <div className='relative w-screen h-screen bg-white z-10 overflow-hidden'>
      ...
      <button className='flex justify-center w-[12svh] h-[12svh] shadow-none bg-transparent active:shadow-none active:scale-110' onClick={routeHome}>
