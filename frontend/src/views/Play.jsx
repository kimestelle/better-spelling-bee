    ...
    <div className='App' id='root'>
      ...
      <p className={`status-message ${statusMessage === '' ? 'empty' : ''}`}>{statusMessage}</p>
        <DragDropContext onDragEnd={onDragEnd}>
                ...
                {duckList.map((duck, index) => (
                  <Draggable key={duck.id} draggableId={duck.id} index={index}>
                    {(provided) => (
                      ...
                      >
                        <Duck key={duck.id} letter={duck.letter} duckAnimate={duckAnimate} sink={duckSink} />
                      </div>
                    )}
                  </Draggable>
                ))}
          ...
          <Droppable droppableId='duck-menu' direction='horizontal'>
            {(provided) => (
                <div className='duck-menu'{...provided.droppableProps} ref={provided.innerRef}>
                  {ducks.map((duck, index) => (
                    <div className={`duck-container ${duck.style}`}>
                    <Draggable key={duck.id} draggableId={duck.id} index={index}>
                      {(provided) => (
                        <div
                          {...provided.draggableProps}
                        ...
                        >
                          <Duck letter={duck.letter} duckAnimate={duck.animate} />
                        </div>
                      )}
                    </Draggable>
                    </div>
